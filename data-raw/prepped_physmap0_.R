...
prep.merge("data/species/physmap6_species.rds", "physmap6", "data/species", speciesdata = TRUE)

## physmap7
prep.merge("data/compartments/physmap7_compartments.rds", "physmap7", "data/compartments")
prep.merge("data/edges/physmap7_edges.rds", "physmap7", "data/edges", edgesdata = TRUE)
prep.merge("data/reactions/physmap7_reactions.rds", "physmap7", "data/reactions", reactionsdata = TRUE)
prep.merge("data/species/physmap7_species.rds", "physmap7", "data/species", speciesdata = TRUE)
...
## physmap9
prep.merge("data/compartments/physmap9_compartments.rds", "physmap9", "data/compartments")
prep.merge("data/edges/physmap9_edges.rds", "physmap9", "data/edges", edgesdata = TRUE)
prep.merge("data/reactions/physmap9_reactions.rds", "physmap9", "data/reactions", reactionsdata = TRUE)
prep.merge("data/species/physmap9_species.rds", "physmap9", "data/species", speciesdata = TRUE)
